...
public class InfoCmd implements IVoicedCommandHandler {

    private static InfoCmd _instance;

    public static final InfoCmd getInstance() {
        if (_instance == null) {
            _instance = new InfoCmd();
        }
    ...
    public String infoWindow() {
        ...
        tb.append("<html>" +
                ...
                "</table>");
        tb.append("<table><tr>");
        tb.append("<td><button value=\"Server Rates\" action=\"bypass -h serverinfo rates\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Server Commands\" action=\"bypass -h serverinfo commands\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Gear Information\" action=\"bypass -h serverinfo gear\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Olympiad Information\" action=\"bypass -h serverinfo olympiad\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Farm Zones Information\" action=\"bypass -h serverinfo farm\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Raidboss Information\" action=\"bypass -h serverinfo raid\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Street Fight Information\" action=\"bypass -h serverinfo sFightInfo\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Server Rules\" action=\"bypass -h serverinfo rules\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr>");
        tb.append("<tr>");
        tb.append("<td><button value=\"Donate Information\" action=\"bypass -h serverinfo donate\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"></td>");
        tb.append("</tr></table>");
    ...
    public String rateWindow() {
        ...
        tb.append("<button value=\"Back\" action=\"bypass -h serverinfo back\" width=280 height=25 back=\"l2wonderlust.active\" fore=\"l2wonderlust.passive\"><br>");
        tb.append("</center></body></html>");
        return tb.toString();
    }
    ...
    public String serverRulesWindow() {
        TextBuilder tb = new TextBuilder();
        tb.append("<html>" +
                "<title>Information Manager</title>" +
