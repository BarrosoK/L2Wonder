...
public class VoicedCommandHandler {
    ...
    private VoicedCommandHandler() {
        ...
        registerVoicedCommandHandler(new ReportCMD());
        registerVoicedCommandHandler(new Menu());
        registerVoicedCommandHandler(new L2MultiFunctionZoneCMD());
        registerVoicedCommandHandler(new InfoCmd());
        registerVoicedCommandHandler(new RaidInfoCmd());

        if (Config.ALLOW_DRESS_ME_SYSTEM) {
            registerVoicedCommandHandler(new DressMe());
        }

        registerVoicedCommandHandler(new VoteCommand());
        ...
        registerVoicedCommandHandler(new BRCmd());
