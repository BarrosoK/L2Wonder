...
public class Continuous implements ISkillHandler {
    ...
    public void useSkill(final L2Character activeChar, L2Skill skill2, final L2Object[] targets) {
        ...
        for (final L2Object target2 : targets) {
            ...
            if (activeChar instanceof L2PlayableInstance && target != activeChar && target.isBuffProtected() && !skill.isHeroSkill() && ((skill.getSkillType() == L2Skill.SkillType.BUFF && skill.getId() != 2005 && skill.getId() != 2037 && skill.getId() != 2166 && skill.getId() != 1418 && skill.getId() != 1410) || skill.getSkillType() == L2Skill.SkillType.FORCE_BUFF || skill.getSkillType() == L2Skill.SkillType.REFLECT)) {
                L2PcInstance refusal;
                refusal = (L2PcInstance) target;
                if (refusal.isInRefusalMode())
                    return;
                continue;
            }
            ...
            if (activeChar instanceof L2PcInstance && activeChar.getPet() != null && !(((L2PcInstance) activeChar).isInOlympiadMode())) {
                ...
                if (!((L2PcInstance) activeChar).isGM() && target instanceof L2Summon && target != summon && (skill.getSkillType() == SkillType.BUFF || skill.getSkillType() == L2Skill.SkillType.FORCE_BUFF)) {
                    continue;
                }
            } else if (activeChar instanceof L2PcInstance && activeChar.getPet() == null && !((L2PcInstance) activeChar).isInOlympiadMode()) {
                if (!((L2PcInstance) activeChar).isGM() && target instanceof L2Summon && (skill.getSkillType() == SkillType.BUFF || skill.getSkillType() == L2Skill.SkillType.FORCE_BUFF)) {
                    continue;
                }
            }
