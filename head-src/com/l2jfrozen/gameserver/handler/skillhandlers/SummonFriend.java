...
public class SummonFriend implements ISkillHandler {
    ...
    public void useSkill(final L2Character activeChar, final L2Skill skill, final L2Object[] targets) {
        ...
        if (L2ArenaManagerInstance.inFightOrWaiting.contains(activeChar)) {
            activePlayer.sendMessage("You cannot summon while in the 1v1 Arena... Stop trying shit.");
            return;
        }
        ...
        try {
            for (final L2Object target1 : targets) {
                ...
                if (target instanceof L2PcInstance) {
                    ...
                    if (L2ArenaManagerInstance.inFightOrWaiting.contains(targetChar)){
                        ((L2PcInstance) activeChar).sendMessage("You can't summon a player who is in 1v1 arena.");
                        return;
                    }
