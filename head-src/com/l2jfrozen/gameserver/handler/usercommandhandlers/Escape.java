...
public class Escape implements IUserCommandHandler
{
	...
	public boolean useUserCommand(final int id, final L2PcInstance activeChar)
	{
		...
		if (L2ArenaManagerInstance.inFightOrWaiting.contains(activeChar)){
			activeChar.sendMessage("You may not escape while in arena.");
			return false;
		}
		...
		if (unstuckTimer < 60000)
			sm.addString("You use Escape to Giran: " + unstuckTimer / 1000 + " seconds.");
		else
			sm.addString("You use Escape to Giran: " + unstuckTimer / 60000 + " minutes.");
	...
	static class EscapeFinalizer implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				{
					_activeChar.teleToLocation(17700, 170176, -3534, true); // Floran
					return;
				}
				
				_activeChar.teleToLocation(81053, 148619, -3495, true);	// Giran
			}
