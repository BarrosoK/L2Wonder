...
public final class Formulas {
        ...
        if (Config.ENABLE_CLASS_DAMAGES && attacker instanceof L2PcInstance && target instanceof L2PcInstance) {
            ...
            if (((L2PcInstance) attacker).isInOlympiadMode() && ((L2PcInstance) target).isInOlympiadMode()) {
                ...
                if (Config.ENABLE_CLASS_DAMAGES_IN_OLY) {
                    ...
                    if (
                            (((L2PcInstance) attacker).getClassId().getId() == 93 ||
                                    ((L2PcInstance) attacker).getClassId().getId() == 101 ||
                                    (((L2PcInstance) attacker).getClassId().getId() == 108)) &&
                                    (((L2PcInstance) target).getClassId().getId() == 99 ||
                                            ((L2PcInstance) target).getClassId().getId() == 106 ||
                                            ((L2PcInstance) target).getClassId().getId() == 90 ||
                                            ((L2PcInstance) target).getClassId().getId() == 91)
                    ) {
                        damage = damage * 1.1;
                    }
                }
                ...
                if ((((L2PcInstance) attacker).getClassId().getId() == 93 ||
                        ((L2PcInstance) attacker).getClassId().getId() == 108) &&
                        ((L2PcInstance) target).getClassId().getId() == 88) {
                    damage = damage * 0.83;
                }
                //wind rider vs gladi
                else if ((((L2PcInstance) attacker).getClassId().getId() == 101) &&
                        (((L2PcInstance) target).getClassId().getId() == 88)) {
                    damage = damage * 1;
                }
                //Adve,GH vs necro,sph
                else if (
                        (((L2PcInstance) attacker).getClassId().getId() == 93 ||
                                (((L2PcInstance) attacker).getClassId().getId() == 108)) &&
                                (((L2PcInstance) target).getClassId().getId() == 95 ||
                                        (((L2PcInstance) target).getClassId().getId() == 110))) {
                    damage = damage * 0.64;
                }
                //wind rider vs necro,sph
                else if ((((L2PcInstance) attacker).getClassId().getId() == 101) &&
                        (((L2PcInstance) target).getClassId().getId() == 95 ||
                                (((L2PcInstance) target).getClassId().getId() == 110))) {
                    damage = damage * 0.72;
                    ...
                    damage = damage * ClassDamageManager.getDamageMultiplier((L2PcInstance) attacker, (L2PcInstance) target);
                    //The config stands here !!
                    //Adventurer vs wind rider
                    if ((((L2PcInstance) attacker).getClassId().getId() == 93) &&
                            (((L2PcInstance) target).getClassId().getId() == 101)) {
                        damage = damage * 0.9;
                    }//daggers vs moonlight sentinel
                    else if (
                            (((L2PcInstance) attacker).getClassId().getId() == 93 ||
                                    ((L2PcInstance) attacker).getClassId().getId() == 101 ||
                                    (((L2PcInstance) attacker).getClassId().getId() == 108)) &&
                                    ((((L2PcInstance) target).getClassId().getId() == 102))) {
                        damage = damage * 0.91;
                    }
                    //wind rider vs Hawkeye
                    else if ((((L2PcInstance) attacker).getClassId().getId() == 101) &&
                            (((L2PcInstance) target).getClassId().getId() == 92)) {
                        damage = damage * 1.1;
                    }
                }
            }
            //if they are not 3rd class make em suck
    ...
    public final static double calcPhysDam(final L2Character attacker, final L2Character target, final L2Skill skill, final boolean shld, final boolean crit, final boolean dual, final boolean ss) {
        if (attacker instanceof L2PcInstance) {
            ...
            if (target instanceof L2PcInstance) {
                if (!pcInst.isGM() && (target).isInsidePeaceZone(pcInst, target) && skill != null && (skill.getTargetType() == L2Skill.SkillTargetType.TARGET_GROUND || skill.getTargetType() == L2Skill.SkillTargetType.TARGET_AREA || skill.getTargetType() == L2Skill.SkillTargetType.TARGET_AURA)) {
                    return 0;
                }
            }
        }
        ...
        if (Config.ENABLE_CLASS_DAMAGES && attacker instanceof L2PcInstance && target instanceof L2PcInstance) {
            ...
            if (((L2PcInstance) attacker).isInOlympiadMode() && ((L2PcInstance) target).isInOlympiadMode()) {
                ...
                if (Config.ENABLE_CLASS_DAMAGES_IN_OLY) {
                    ...
                    //Olympiad
                    //gladi vs archers OLY
                    if ((((L2PcInstance) attacker).getClassId().getId() == 88) &&
                            (((L2PcInstance) target).getClassId().getId() == 109 ||
                                    ((L2PcInstance) target).getClassId().getId() == 102 ||
                                    (((L2PcInstance) target).getClassId().getId() == 92))) {
                        damage = damage * 0.6;
                    }
                    ...
                    //gladi vs mages OLY
                            ...
                            (((L2PcInstance) attacker).getClassId().getId() == 88) &&
                                    (((L2PcInstance) target).getClassId().getId() == 95 ||
                                            ((L2PcInstance) target).getClassId().getId() == 110 ||
                                            ((L2PcInstance) target).getClassId().getId() == 103 ||
                                            ((L2PcInstance) target).getClassId().getId() == 94 ||
                                            ((L2PcInstance) target).getClassId().getId() == 98 ||
                                            ((L2PcInstance) target).getClassId().getId() == 97 ||
                                            ((L2PcInstance) target).getClassId().getId() == 112 ||
                                            ((L2PcInstance) target).getClassId().getId() == 105
                                    )) {
                        damage = damage * 0.63;
                    }//gladi vs summoners OLY
                    else if (
                            (((L2PcInstance) attacker).getClassId().getId() == 88) &&
                                    (((L2PcInstance) target).getClassId().getId() == 96 ||
                                            ((L2PcInstance) target).getClassId().getId() == 111 ||
                                            ((L2PcInstance) target).getClassId().getId() == 104
                                    )) {
                        damage = damage * 0.77;
                    }
                    //gladi vs ol,wc OLY
                            ...
                            (((L2PcInstance) attacker).getClassId().getId() == 88) &&
                                    (((L2PcInstance) target).getClassId().getId() == 115 ||
                                            ((L2PcInstance) target).getClassId().getId() == 116
                                    )) {
                        damage = damage * 0.80;
                    }
                    //gladi vs daggers OLY
                    else if ((((L2PcInstance) attacker).getClassId().getId() == 88) &&
                            (((L2PcInstance) target).getClassId().getId() == 93 ||
                                    ((L2PcInstance) target).getClassId().getId() == 101 ||
                                    ((L2PcInstance) target).getClassId().getId() == 108)) {
                        damage = damage * 0.70;
                    }//gladi vs tyrant OLY
                    else if ((((L2PcInstance) attacker).getClassId().getId() == 88) &&
                            (((L2PcInstance) target).getClassId().getId() == 114)) {
                        damage = damage * 0.74;
                    }
                    //Fighters VS archers,daggers,tyrant OLY
                    else if (((L2PcInstance) target).getClassId().getId() == 93 ||
                            ((L2PcInstance) target).getClassId().getId() == 101 ||
                            ((L2PcInstance) target).getClassId().getId() == 114 ||
                            ((L2PcInstance) target).getClassId().getId() == 109 ||
                            ((L2PcInstance) target).getClassId().getId() == 102 ||
                ...
                else if ((((L2PcInstance) attacker).getClassId().getId() == 92 ||
                        ((L2PcInstance) attacker).getClassId().getId() == 109 ||
                        ((L2PcInstance) attacker).getClassId().getId() == 102) &&
                        (((L2PcInstance) target).getClassId().getId() == 93 ||
                                ((L2PcInstance) target).getClassId().getId() == 108)
                ) {
                    damage = damage * 1.12;
                ...
                //Moonlight vs Wind rider
                else if ((((L2PcInstance) attacker).getClassId().getId() == 102) &&
                        (
                                ((L2PcInstance) target).getClassId().getId() == 101)
                ) {
                    damage = damage * 1.21;
                ...
                //GS vs Wind rider
                else if ((((L2PcInstance) attacker).getClassId().getId() == 109) &&
                        (
                                ((L2PcInstance) target).getClassId().getId() == 101)
                ) {
                    damage = damage * 1.12;
                ...
                //archers vs gladi
                        ...
                        (((L2PcInstance) attacker).getClassId().getId() == 92 ||
                                ((L2PcInstance) attacker).getClassId().getId() == 109 ||
                                ((L2PcInstance) attacker).getClassId().getId() == 102) &&
                                (((L2PcInstance) target).getClassId().getId() == 88)) {
                    damage = damage * 1.27;
                }//gladi vs Sagi,Moonlight sentinel
                else if (
                        ((((L2PcInstance) attacker).getClassId().getId() == 88) &&
                                ((L2PcInstance) target).getClassId().getId() == 92 ||
                                ((L2PcInstance) target).getClassId().getId() == 102)
                ...
                //gladi vs daggers
                    ...
                    damage = damage * 0.83;
                        ...
                        (((L2PcInstance) attacker).getClassId().getId() == 114) &&
                                ((L2PcInstance) target).getClassId().getId() == 109 ||
                                ((L2PcInstance) target).getClassId().getId() == 102 ||
                                ((L2PcInstance) target).getClassId().getId() == 92) {
                    damage = damage * 0.63;
                }//paladin vs gladi
                else if ((((L2PcInstance) attacker).getClassId().getId() == 90) &&
                        ((L2PcInstance) target).getClassId().getId() == 88) {
                    damage = damage * 1.45;
                } else {
                    damage = damage * ClassDamageManager.getDamageMultiplier((L2PcInstance) attacker, (L2PcInstance) target);
                    ...
                    //Fighters VS Bishops
                    if (((L2PcInstance) target).getClassId().getId() == 97) {
                        damage *= 1.2;
                    }
                    //GS vs Moonlight
                    else if ((((L2PcInstance) attacker).getClassId().getId() == 109) &&
                    ...
                    //TITAN on bow
                    if ((((L2PcInstance) attacker).getClassId().getId() == 113) && weapon != null && weapon.getItemType() == L2WeaponType.BOW) {
                        damage *= 0.7;
                    }
            ...
            if (((L2PcInstance) attacker).isInOlympiadMode() && ((L2PcInstance) target).isInOlympiadMode()) {
                ...
                if (Config.ENABLE_CLASS_DAMAGES_IN_OLY) {
                    ...
                    if ((((L2PcInstance) attacker).getClassId().getId() == 103 ||
                            ((L2PcInstance) attacker).getClassId().getId() == 94 ||
                            ((L2PcInstance) attacker).getClassId().getId() == 95) ||
                            (((L2PcInstance) attacker).getClassId().getId() == 110) &&
                                    (((L2PcInstance) target).getClassId().getId() == 98)) {
                        damage = damage * 1.13;
                    }
                }
                ...
                if ((((L2PcInstance) attacker).getClassId().getId() == 103 ||
                        ...
                        (((L2PcInstance) target).getClassId().getId() == 108)) {
                    damage = damage * 1.40;
                }//sps,archmage vs Sagi,Moonlight
                else if (
                        (((L2PcInstance) attacker).getClassId().getId() == 103 ||
                                ((L2PcInstance) attacker).getClassId().getId() == 94) &&
                                (((L2PcInstance) target).getClassId().getId() == 102 ||
                                        (((L2PcInstance) target).getClassId().getId() == 92))) {
                    damage = damage * 1.82;
    ...
    public static boolean calcEffectSuccess(final L2Character attacker, final L2Character target, final EffectTemplate effect, final L2Skill skill, final boolean ss, final boolean sps, final boolean bss) {
        ...
        if (skill.getId() == 3586 || skill.getId() == 3585) {
            rate = 0;
        } else if (skill.getId() == 3590 || skill.getId() == 3589) {
            rate = 1;
        }
    ...
    public boolean calcSkillSuccess(final L2Character attacker, final L2Character target, final L2Skill skill, final boolean ss, final boolean sps, final boolean bss) {
        ...
        if (skill.isMagic()) {
            ...
            if (attacker instanceof L2PcInstance && target instanceof L2PcInstance) {
                if (!((L2PcInstance) attacker).isInOlympiadMode() && !((L2PcInstance) target).isInOlympiadMode()) {
                    mAtkModifier = 14 * Math.sqrt(ssModifier * attacker.getMAtkCustom(target, skill)) / mAtkModifier;
                } else {
                    mAtkModifier = 14 * Math.sqrt(ssModifier * attacker.getMAtk(target, skill)) / mAtkModifier;
                }
        ...
        if (skill.getId() == 1417) {
            rate *= 2.05;
        } else if (skill.getId() == 1236) {
            rate *= 1.7;
        } else if (skill.getId() == 3586 || skill.getId() == 3585) {
            rate = 0;
        } else if (skill.getId() == 3590 || skill.getId() == 3589) {
            rate = 1;
        } else if (skill.getId() == 1339 || skill.getId() == 1343 || skill.getId() == 1342) {
            rate *= 1.5;
        } else if (skill.getId() == 1340) {
            rate *= 1.3;
        } else if (skill.getId() == 1097) {
            rate = 7;
        }
