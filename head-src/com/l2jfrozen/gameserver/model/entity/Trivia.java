...
public class Trivia {
    ...
    //ID of the reward
    private static int _rewardID = 6392;
    //Ammount of the reward
    private static int _rewardCount = 5;
    private static long questionTime = 0;
    private static HashMap<String, String> q_a = new HashMap<String, String>();
    ...
    public static void handleAnswer(String s, L2PcInstance pi) {
        if (s.equalsIgnoreCase(answer)) {
            ...
            Announcements.getInstance().announceToAll("Winner is " + pi.getName() + "! He answered in " + (System.currentTimeMillis() - questionTime) / 1000 + " seconds!");
            announceCorrect();
    ...
    public static void startTrivia() {
        Announcements.getInstance().announceToAll("Trivia Event begins! You have to PM Trivia with your answer, get ready!");
    ...
    public static void askQuestion() {
        asked = true;
        pickQuestion();
        Announcements.getInstance().announceToAll("Question: " + question);
    ...
    public static void announceCorrect() {
        ...
        Announcements.getInstance().announceToAll("The correct answer was: " + answer);
        setState(EventState.ASKING);
    }
