...
public abstract class L2Skill {
    ...
    public final L2Object[] getTargetList(final L2Character activeChar, final boolean onlyFirst, L2Character target) {
        ...
        switch (targetType) {
            ...
            case TARGET_AURA: {
                ...
                for (final L2Object obj : activeChar.getKnownList().getKnownCharactersInRadius(radius)) {
                    ...
                    if (isOffensive() && L2Character.isInsidePeaceZone(target, activeChar)) {
                        if ((getId() == 286 && (obj instanceof L2MonsterInstance))) {
                        } else {
                            continue;
                        }
                    }
                        ...
                        if (obj instanceof L2PcInstance) {
                            ...
                            if (!srcInArena && !(((L2Character) obj).isInsideZone(L2Character.ZONE_PVP) && !((L2Character) obj).isInsideZone(L2Character.ZONE_SIEGE))) {
                                ...
                                if (srcInArena && ((L2Character) obj).isInsideZone(L2Character.ZONE_PVP)) {
                                    if (src.getParty() != null && ((L2PcInstance) obj).getParty() != null && // Is in the same party???
            ...
            case TARGET_MULTIFACE: {
                if ((!(target instanceof L2Attackable) && !(target instanceof L2PcInstance)) || (target == activeChar)) {
                    activeChar.sendPacket(new SystemMessage(SystemMessageId.TARGET_IS_INCORRECT));
                    return null;
                }
            ...
            case TARGET_PARTY: {
                ...
                if (activeChar.getParty() != null) {
                    ...
                    for (final L2PcInstance partyMember : partyList) {
                        ...
                        if (((TvT.is_started() && !Config.TVT_ALLOW_INTERFERENCE) || (CTF.is_started() && !Config.CTF_ALLOW_INTERFERENCE) || (DM.is_started() && !Config.DM_ALLOW_INTERFERENCE) || (BattleRoyale.is_started() && !Config.BR_ALLOW_INTERFERENCE))/* && !player.isGM() */) {
                ...
                if (activeChar instanceof L2PcInstance) {
                    ...
                    if (clan != null) {
                        ...
                        for (final L2ClanMember member : clan.getMembers()) {
                            ...
                            if (L2ArenaManagerInstance.inFightOrWaiting.contains(player) && L2ArenaManagerInstance.inFightOrWaiting.contains(newTarget) && (player.getParty() == null || !player.getParty().getPartyMembers().contains(newTarget))) {
                                continue;
                            }
    ...
    public boolean checkPartyClan(final L2Character activeChar, final L2Object target) {
        if (activeChar instanceof L2PcInstance && target instanceof L2PcInstance) {
            ...
            if ((activeCh._inEvent && targetChar._inEvent) || (activeCh._inEventDM && targetChar._inEventDM) || (activeCh._inEventTvT && targetChar._inEventTvT) || (activeCh._inEventCTF && targetChar._inEventCTF) || (activeCh._inEventVIP && targetChar._inEventVIP) || (activeCh._inEventBR && targetChar._inEventBR)) {
                return false;
            }
            ...
            if (L2ArenaManagerInstance.inFightOrWaiting.contains(activeCh) && L2ArenaManagerInstance.inFightOrWaiting.contains(targetChar)) {
                return false;
            }
            ...
            if (activeCh.getAllyId() != 0 && activeCh.getAllyId() == ((L2PcInstance) targetChar).getAllyId()) {
                return true;
            }
