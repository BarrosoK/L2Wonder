	...
	public boolean doDie(final L2Character killer)
	{
		...
		if (player != null)
		{
			...
			if (player.getParty() != null)
			{
				...
				{
					if (getNpcId() == 25325 && !member.isNoble() && member.isInsideRadius(getX(), getY(), getZ(), 1000, false, false))
					{
			...
			if (getNpcId() == 25325 && !player.isNoble() && player.isInsideRadius(getX(), getY(), getZ(), 1000, false, false))
			{
