...
/*
            if (this.getTownId() == 9 && character instanceof L2PcInstance && FakeOnline.fakeplayers != null && !FakeOnline.fakeplayers.contains(character)) {
                ...
                for (L2PcInstance p : FakeOnline.fakeplayers) {
                    ...
                    if (n <= 25) {
                        //p.getAI().setIntention(CtrlIntention.AI_INTENTION_MOVE_TO, new L2CharPosition(p.getX()+10, p.getY()+10, p.getZ(), 0));
                    } else if (n <= 50) {
                        //p.getAI().setIntention(CtrlIntention.AI_INTENTION_MOVE_TO, new L2CharPosition(p.getX()-10, p.getY()+10, p.getZ(), 0));
                    } else if (n <= 75) {
                        //p.getAI().setIntention(CtrlIntention.AI_INTENTION_MOVE_TO, new L2CharPosition(p.getX()-10, p.getY()-10, p.getZ(), 0));
