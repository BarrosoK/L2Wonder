...
public class L2Attackable extends L2NpcInstance {
    ...
    public boolean doDie(final L2Character killer) {
        ...
        if (Config.L2JMOD_CHAMPION_ENABLE) {
            ...
            if (!(this instanceof L2GrandBossInstance) && !(this instanceof L2RaidBossInstance) && this instanceof L2MonsterInstance && !this.isInsideZone(ZONE_PEACE) && !this.isInsideZone(ZONE_PARTYPVP)
                    ...
                    if (attackerParty == null) {
                        ...
                        if (attacker.getKnownList().knowsObject(this)) {
                            ...
                            if (!attacker.isDead()) {
                                ...
                                if ((this instanceof L2GrandBossInstance || (this.getNpcId() == 38611 || this.getNpcId() == 38619 || this.getNpcId() == 38603)) && attacker instanceof L2PcInstance) {
                                    ((L2PcInstance) attacker).setKarma(0);
                                }
                            }
                        }
                    } else {
    ...
    public void doItemDrop(final L2NpcTemplate npcTemplate, final L2Character lastAttacker) {
        ...
        if (Config.L2JMOD_CHAMPION_ENABLE && isChampion()) {
            ...
            for (Quest q : player.getAllActiveQuests()) {
                if (q.getQuestIntId() == 802) {
                    hasQuest = true;
                }
            }
            if (hasQuest) {
                player.addItem("ChampionLoot", 4326, 1, this, true);
