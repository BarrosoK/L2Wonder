  ...
  public static String VOTE_HOPZONE_APIKEY;
	...
	public static void load()
	{
		try
		{
			...
			VOTE_NETWORK_NAME = p.getProperty("VoteNetworkName", "");
			      VOTE_TOPZONE_APIKEY = p.getProperty("VoteTopzoneApiKey", "");
			      VOTE_TOPZONE_SERVERID = Integer.parseInt(p.getProperty("VoteTopzoneServerId", "0"));
			      VOTE_HOPZONE_APIKEY = p.getProperty("VoteHopzoneApiKey", "");
