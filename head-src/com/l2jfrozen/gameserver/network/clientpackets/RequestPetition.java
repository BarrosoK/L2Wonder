...
public final class RequestPetition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage("No GMs online, to contact the GM team use our ticket system in our website www.l2wonderlust.com.");
			activeChar.sendPacket(new ExShowScreenMessage("Use ticket system in www.l2wonderlust.com",8000));
