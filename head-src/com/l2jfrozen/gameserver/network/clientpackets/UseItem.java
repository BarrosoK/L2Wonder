...
public final class UseItem extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        /*
        if (getClient().getActiveChar().isInsideMultifunctionZone && !L2MultiFunctionZone.checkItem(item)) {
        ...
        */
        ...
        if (L2ArenaManagerInstance.inFightOrWaiting.contains(activeChar) && Arrays.toString(escape_scrolls_id).contains(String.valueOf(item.getItemId()))){
            activeChar.sendMessage("You can't use scroll of escape here.");
            return;
        }
