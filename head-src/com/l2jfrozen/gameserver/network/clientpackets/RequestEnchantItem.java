...
public final class RequestEnchantItem extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        Collection<L2Character> knowns = activeChar.getKnownList().getKnownCharactersInRadius(180);
        ...
        synchronized (item) {
            if (rndValue < chance) {
                ...
                if (crystalScroll) {
                    sm = SystemMessage.sendString("Failed in Crystal Enchant. The enchant value of the item will not increase");
                    activeChar.sendPacket(sm);
