...
public final class RequestExEnchantSkill extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (!getClient().getFloodProtectors().getServerBypass().tryPerformAction("Enchant Skills"))
            return;
                    ...
                    if (_skillLvl > 140) {
                        ...
                        switch (_skillLvl) {
                            ...
                            case 151:
                                ...
                                break;
                            case 152:
                                if (dc == null || dc.getCount() < 8)
                                {
                                    player.sendPacket(new SystemMessage(SystemMessageId.YOU_DONT_HAVE_ALL_OF_THE_ITEMS_NEEDED_TO_ENCHANT_THAT_SKILL));
                                    return;
                                }
                                player.destroyItemByItemId("Consume", 4037, 8, trainer, true);
                                break;
