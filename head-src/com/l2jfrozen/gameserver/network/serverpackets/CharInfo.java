    ...
    protected final void writeImpl() {
        ...
        if (_activeChar.getPoly().isMorphed()) {
            ...
            if (template != null) {
                ...
                if ((_activeChar.isInStartedBREvent() || _activeChar.isInsideBattleRoyaleZone) || (_activeChar.isInStartedDMEvent() || _activeChar._inEventDM && DM.is_teleport())) {
                    writeF(9);
                    writeF(18);
                } else {
            ...
            if (_activeChar.isInStartedBREvent() && _activeChar.isInsideBattleRoyaleZone) {
                writeS("Battle Royale");
                writeD(4);
                writeD(1);
            } else if (_activeChar.isInStartedBREvent() || _activeChar.isInsideBattleRoyaleZone) {
                writeS(_activeChar.getName());
                writeD(4);
                writeD(1);
            } else if (_activeChar.isInStartedDMEvent() || (_activeChar._inEventDM && DM.is_teleport())) {
                writeS("Deathmatch");
                writeD(4);
                writeD(1);
            } else {
            ...
            if (_activeChar.isDressMeEnabled() && _activeChar.getDressMeData() != null && _activeChar.getDressMeData().getChestId() != 0) {
                L2ItemInstance costume = _activeChar.getInventory().getItemByItemId(_activeChar.getDressMeData().getChestId());
                if (costume == null) {
                    _activeChar.setDressMeEnabled(false);
                    _activeChar.getDressMeData().setChestId(0);
                }
            }
            ...
            if (!_activeChar.isDressMeEnabled() || _activeChar.getDressMeData() == null || _activeChar.getDressMeData().getChestId() == 0) {
                ...
                if (_activeChar.isInStartedBREvent() || _activeChar.isInsideBattleRoyaleZone) {
                    ...
                    writeD(_activeChar.getDressMeData().getChestId());
                }
                writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_LEGS));
                writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_FEET));
                writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_BACK));
            ...
            //+17 color for lvl 2 wonder weaps
            if (_activeChar.getActiveWeaponInstance() != null && _activeChar.getActiveWeaponInstance().getEnchantLevel() == 16 && _activeChar.getActiveWeaponInstance().getItemId() >= 19842 && _activeChar.getActiveWeaponInstance().getItemId() <= 19871) {
                writeC(_activeChar.isMounted() ? 0 : Math.min(127, 17));
            } else {
