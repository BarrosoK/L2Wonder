...
public class Die extends L2GameServerPacket
{
	...
	public Die(final L2Character cha)
	{
		...
		if (cha instanceof L2PcInstance)
		{
			...
			_canTeleport = !((TvT.is_started() && player._inEventTvT) || (DM.is_started() && player._inEventDM) || (CTF.is_started() && player._inEventCTF) || player.isInFunEvent() || player.isPendingRevive()|| (player.isInsideMultifunctionZone && L2MultiFunctionZone.revive));
		}
	...
	protected final void writeImpl()
	{
		...
		writeD(_canTeleport ? 0x01 : 0x01); // 6d 00 00 00 00 - to nearest village
