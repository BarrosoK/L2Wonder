...
public final class Config {
     ...
     * Ad Filter
     **/
    public static ArrayList<String> ADFILTER_LIST = new ArrayList<>();
    ...
    public static void loadOtherConfig() {
        ...
        try {
            ...
            STRIDER_SPEED = Integer.parseInt(otherSettings.getProperty("StriderSpeed", "100"));
    ...
    public static boolean L2JMOD_ALLOW_WEDDING_COLOR;
    ...
    public static void loadWeddingConfig() {
        ...
        try {
            ...
            L2JMOD_ALLOW_WEDDING_COLOR = Boolean.parseBoolean(WeddingSettings.getProperty("AllowWeddingColors", "False"));
    ...
    public static boolean ALLOW_FAKEPLAYERS_SYSTEM;
    public static int FAKEPLAYERS_COUNT;
    ...
    public static void loadTriviaConfig() {
        ...
        try {
            final Properties TriviaSettings = new Properties();
            final InputStream is = new FileInputStream(new File(EVENT_TRIVIA));
            ...
            TRIVIA_INTERVAL.addAll(Arrays.asList(times));
    ...
    public static void loadDRESSMEConfig() {
        final String DRESSME_SYSTEM = FService.DRESSME_SYSTEM_FILE;

        try {
            final Properties DRESSMESettings = new Properties();
            final InputStream is = new FileInputStream(new File(DRESSME_SYSTEM));
            DRESSMESettings.load(is);
            is.close();

            ALLOW_DRESS_ME_SYSTEM = Boolean.parseBoolean(DRESSMESettings.getProperty("AllowDressMeSystem", "false"));
            String temp = DRESSMESettings.getProperty("DressMeChests", "");
            ...
            e.printStackTrace();
            throw new Error("Failed to Load " + DRESSME_SYSTEM + " File.");
        }
    }

    public static void loadFAKEPLAYERSConfig() {
        final String FAKEPLAYERS_SYSTEM = FService.FAKEPLAYERS_SYSTEM_FILE;

        try {
            final Properties FAKEPLAYERSSettings = new Properties();
            final InputStream is = new FileInputStream(new File(FAKEPLAYERS_SYSTEM));
            FAKEPLAYERSSettings.load(is);
            is.close();

            ALLOW_FAKEPLAYERS_SYSTEM = Boolean.parseBoolean(FAKEPLAYERSSettings.getProperty("EnableFakePlayers", "false"));
            FAKEPLAYERS_COUNT =Integer.parseInt(FAKEPLAYERSSettings.getProperty("FakePlayersCount", "0"));


        } catch (final Exception e) {
            e.printStackTrace();
            throw new Error("Failed to Load " + FAKEPLAYERS_SYSTEM + " File.");
        }
    }
    ...
    // ============================================================
    public static boolean BR_ALLOW_INTERFERENCE;
    public static boolean BR_ALLOW_POTIONS;
    public static boolean BR_ALLOW_SUMMON;
    public static boolean BR_JOIN_CURSED;
    public static boolean BR_ON_START_REMOVE_ALL_EFFECTS;
    public static boolean BR_ON_START_UNSUMMON_PET;
    public static boolean BR_COMMAND;
    public static boolean BR_ANNOUNCE_REWARD;
    public static int BR_SPAWN_OFFSET;
    public static boolean BR_STATS_LOGGER;
    public static boolean BR_ALLOW_HEALER_CLASSES;
    public static boolean BR_REMOVE_BUFFS_ON_DIE;

    // ============================================================
    public static void loadBRConfig() {
        final String EVENT_BR = FService.EVENT_BR_FILE;

        try {
            final Properties BRSettings = new Properties();
            final InputStream is = new FileInputStream(new File(EVENT_BR));
            BRSettings.load(is);
            is.close();

            BR_ALLOW_INTERFERENCE = Boolean.parseBoolean(BRSettings.getProperty("BRAllowInterference", "False"));
            BR_ALLOW_POTIONS = Boolean.parseBoolean(BRSettings.getProperty("BRAllowPotions", "False"));
            BR_ALLOW_SUMMON = Boolean.parseBoolean(BRSettings.getProperty("BRAllowSummon", "False"));
            BR_JOIN_CURSED = Boolean.parseBoolean(BRSettings.getProperty("BRJoinWithCursedWeapon", "False"));
            BR_ON_START_REMOVE_ALL_EFFECTS = Boolean.parseBoolean(BRSettings.getProperty("BROnStartRemoveAllEffects", "True"));
            BR_ON_START_UNSUMMON_PET = Boolean.parseBoolean(BRSettings.getProperty("BROnStartUnsummonPet", "True"));

             BR_COMMAND = Boolean.parseBoolean(BRSettings.getProperty("BRCommand", "False"));
            BR_ANNOUNCE_REWARD = Boolean.parseBoolean(BRSettings.getProperty("BRAnnounceReward", "False"));
            BR_SPAWN_OFFSET = Integer.parseInt(BRSettings.getProperty("BRSpawnOffset", "100"));
            BR_STATS_LOGGER = Boolean.parseBoolean(BRSettings.getProperty("BRStatsLogger", "true"));
            BR_ALLOW_HEALER_CLASSES = Boolean.parseBoolean(BRSettings.getProperty("BRAllowedHealerClasses", "true"));
            BR_REMOVE_BUFFS_ON_DIE = Boolean.parseBoolean(BRSettings.getProperty("BRRemoveBuffsOnPlayerDie", "false"));

        } catch (final Exception e) {
            e.printStackTrace();
            throw new Error("Failed to Load " + EVENT_BR + " File.");
        }
    }
    ...
    public static void loadL2JFrozenConfig() {
        ...
        try {
            ...
            LS_STACKABLE = Boolean.parseBoolean(L2JFrozenSettings.getProperty("LSStackable", "True"));
            BOG_STACKABLE = Boolean.parseBoolean(L2JFrozenSettings.getProperty("BOGStackable", "True"));
    ...
    public static int ALT_OLY_HERO_TIME;
    ...
    public static void loadOlympConfig() {
        ...
        try {
            ...
            is.close();
            ALT_OLY_HERO_TIME = Integer.parseInt(OLYMPSetting.getProperty("AltOlyHeroTime", "22"));
    ...
    public static boolean BOTS_PREVENTION = false;
    public static int KILLS_COUNTER = 50;
    public static int KILLS_COUNTER_RANDOMIZATION = 50;
    public static int VALIDATION_TIME = 60;
    public static int PUNISHMENT = 0;
    public static int PUNISHMENT_TIME = 5;
    ...
    public static void loadPHYSICSConfig() {
        ...
        try {
            ...
            ENABLE_ANTI_HEAVY = Boolean.parseBoolean(PHYSICSSetting.getProperty("EnableAntiHeavySystem", "true"));
            ...
            MAX_RUN_SPEED = Integer.parseInt(PHYSICSSetting.getProperty("MaxRunSpeed", "500"));
    ...
    public static int CRIXUS_RESP_FIRST;
    public static int CRIXUS_RESP_SECOND;

    public static int SPARTAKUS_RESP_FIRST;
    public static int SPARTAKUS_RESP_SECOND;

    public static int ONAEMAUS_RESP_FIRST;
    public static int ONAEMAUS_RESP_SECOND;

    public static int GANNICUS_RESP_FIRST;
    public static int GANNICUS_RESP_SECOND;

    public static int AGRON_RESP_FIRST;
    public static int AGRON_RESP_SECOND;

    public static int ASHUR_RESP_FIRST;
    public static int ASHUR_RESP_SECOND;

    public static int BARAKIEL_RESP_FIRST;
    public static int BARAKIEL_RESP_SECOND;
    ...
    public static void loadBossConfig() {
        ...
        try {
            ...
            ANTHARAS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("AntharasRespFirst", "6"));
            ...
            BAIUM_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("BaiumRespFirst", "6"));
            ...
            CORE_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("CoreRespFirst", "2"));
            ...
            QA_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("QueenAntRespFirst", "4"));
            ...
            // ============================================================
            //Crixus
            CRIXUS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("CrixusRespFirst", "6"));
            CRIXUS_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("CrixusRespSecond", "0"));
            //Spartakus
            SPARTAKUS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("SpartakusRespFirst", "6"));
            SPARTAKUS_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("SpartakusRespSecond", "0"));
            //Onaemaus
            ONAEMAUS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("OnaemausRespFirst", "12"));
            ONAEMAUS_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("OnaemausRespSecond", "0"));
            //Gannicus
            GANNICUS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("GannicusRespFirst", "6"));
            GANNICUS_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("GannicusRespSecond", "0"));
            //Agron
            AGRON_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("AgronRespFirst", "6"));
            AGRON_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("AgronRespSecond", "0"));
            //Ashur
            ASHUR_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("AshurRespFirst", "12"));
            ASHUR_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("AshurRespSecond", "0"));
            //Barakiel
            BARAKIEL_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("BarakielRespFirst", "4"));
            BARAKIEL_RESP_SECOND = Integer.parseInt(bossSettings.getProperty("BarakielRespSecond", "0"));
            // ZAKEN
            ZAKEN_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("ZakenRespFirst", "4"));
            ...
            // ============================================================
            // ORFEN
            ORFEN_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("OrfenRespFirst", "2"));
            ...
            // ============================================================
            // VALAKAS
            VALAKAS_RESP_FIRST = Integer.parseInt(bossSettings.getProperty("ValakasRespFirst", "6"));
     ...
     */
    // ==============================================================
    public static void loadAdFilter() {

        final String FILTER_FILE = FService.ADFILTER_FILE;
        LineNumberReader lnr = null;
        try {
            final File filter_file = new File(FILTER_FILE);
            if (!filter_file.exists()) {
            ...
            while ((line = lnr.readLine()) != null) {
                ...
                ADFILTER_LIST.add(line.trim());
            }
            LOGGER.info("Loaded " + ADFILTER_LIST.size() + " Filter Words.");
        } catch (final Exception e) {
            e.printStackTrace();
            throw new Error("Failed to Load " + FILTER_FILE + " File.");
        } finally {
