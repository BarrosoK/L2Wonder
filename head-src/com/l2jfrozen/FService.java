...
public class FService
{
	...
	public static final String ADFILTER_FILE = "./config/adfilter.txt";
	...
	public static final String EVENT_BR_FILE = "./config/frozen/br.properties";
	...
	public static final String EVENT_TRIVIA_FILE = "./config/frozen/trivia.properties";
	...
	public static final String DRESSME_SYSTEM_FILE = "./config/fun/dressme.properties";
	public static final String FAKEPLAYERS_SYSTEM_FILE = "./config/fun/fakeplayers.properties";
